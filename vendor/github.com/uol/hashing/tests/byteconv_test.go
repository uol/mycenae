...
func TestConvertMap(t *testing.T) {
	...
	expected = []byte{0x6b, 0x31, 0x76, 0x31, 0x6b, 0x32, 0x76, 0x32}
	assert.Equal(t, expected, generateByteArray(t, m3), "expected %v", expected)
	...
	expected = []byte{0x6b, 0x31, 0x76, 0x31, 0x6b, 0x32, 0x76, 0x32}
	assert.Equal(t, expected, generateByteArray(t, m4), "expected %v", expected)
}
